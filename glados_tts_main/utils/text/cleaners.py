...
from glados_tts_main.utils.text.numbers import normalize_numbers
from glados_tts_main.utils.text.symbols import phonemes_set
...
class Cleaner:
    ...
    def __init__(self,
        ...
        self.lang = lang
        if use_phonemes:
            self.phonemize = Phonemizer.from_checkpoint('glados_tts_main/models/en_us_cmudict_ipa_forward.pt')
